...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-proid" class="form-control" name="row[proid]" type="number">
        </div>
    </div>
