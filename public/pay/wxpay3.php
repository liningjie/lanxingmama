...
try{
	...
	// $input->SetTotal_fee($data['price']*100);//钱
...
<head>
    ...
    <title><?php echo($data['title'])?>-微信支付</title>
...
<body>
    <br/>
    <font color="#9ACD32"><b>该笔订单支付金额为<span style="color:#f00;font-size:50px"><?php echo($data['price']);?></span>钱</b></font><br/><br/>
	<div align="center">
